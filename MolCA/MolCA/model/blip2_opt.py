...
class Blip2OPT(Blip2Base):
    ...
    def __init__(
        ...
        self.graph_encoder, self.ln_graph = self.init_graph_encoder(gin_num_layers, gin_hidden_dim, gin_drop_ratio, ckpt_path=args.gnn_ckpt)
    ...
    def forward(self, batch):
        ...
        #print("prompt_tokens.input_ids shape:", prompt_tokens.input_ids.shape)
        prompt_embeds = self.opt_model.get_input_embeddings()(prompt_tokens.input_ids)
        #print("prompt_embeds shape:", prompt_embeds.shape)
        #print("mol_tokens shape:", mol_tokens.shape)
        #print("prompt_tokens.is_mol_token shape:", prompt_tokens.is_mol_token.shape)
